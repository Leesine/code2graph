...
class Statistic:
    ...
    def calculate_statistic(labels: torch.Tensor, preds: torch.Tensor,
        ...
        statistic.true_negative, statistic.false_positive, statistic.false_negative, statistic.true_positive = confusion_matrix[0,0], confusion_matrix[0,1], confusion_matrix[1,0], confusion_matrix[1,1]
        return statistic
